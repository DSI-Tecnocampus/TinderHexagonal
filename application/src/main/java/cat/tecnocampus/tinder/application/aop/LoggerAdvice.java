...
public class LoggerAdvice {
    ...
    @Pointcut("execution(* cat.tecnocampus.tinder.application.service.ReadTinderService.getProfilesLazy(..))")
    ...
    @Pointcut("execution(* cat.tecnocampus.tinder.application.service.ReadTinderService.*Likes*(..))")
    ...
    @Pointcut("execution(public java.util.List<cat.tecnocampus.tinder.application.dto.ProfileDTO> cat.tecnocampus.tinder.application.service.ReadTinderService.*Eager(..))")
    ...
    @Pointcut("execution(* cat.tecnocampus.tinder.application.service.ReadTinderService.getCandidates(..)) && args(id)")
